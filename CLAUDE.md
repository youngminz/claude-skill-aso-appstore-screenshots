...
- **compose.mjs** — The primary screenshot renderer. It uses Playwright + HTML/CSS to deterministically render App Store screenshot scaffolds from a background hex colour, action verb, benefit descriptor, and simulator screenshot path.
